        ...
        <div className="md:w-full md:h-full  flex flex-col md:flex-1">
          ...
          <div className="lg:w-[501px] lg:h-[373px]">
            ...
            <p className=" lg:w-[501px]  lg:text-[17px] font-[-200] leading-8 text-[#6F6F73] mt-3">
              Welcome to EduHub, your gateway to expert-led courses. Learn at
              your own pace and unlock your potential with EduHub today.
            </p>
            <div className="flex md:flex-row flex-col items-center md:items-start mt-10 gap-8">
              <Link href={"/courses"} className="items-center" >
                <ButtonIcon 
                  name={"Browse Courses"}
